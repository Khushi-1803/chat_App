...
const LoginPage = () => {
  ...
  return (
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:justify-evenly max-sm:flex-col backdrop-blur-xl'>
      {/* LEFT */}
      <div className='flex flex-col gap-3'>
        <img src={assets.logo} alt="" className='w-[min(25vw,200px)]' />
        <p className='ml-10 text-4xl text-white'>Buzzly</p>
      </div>
      {/* RIGHT */}
